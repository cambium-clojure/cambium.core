(defproject cambium/cambium.core "1.0.0-SNAPSHOT"
  ...
  :profiles {:provided {:dependencies [[org.clojure/clojure "1.6.0"]]}
             ...
             :log4j12 {:dependencies [[org.slf4j/slf4j-log4j12 "1.7.30"]
                                      [log4j/log4j "1.2.17"]]}
             :log4j2  {:dependencies [[org.apache.logging.log4j/log4j-api  "2.13.3" :exclusions [org.slf4j/slf4j-api]]
                                      [org.apache.logging.log4j/log4j-core "2.13.3" :exclusions [org.slf4j/slf4j-api]]
